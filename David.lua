...
if Status or SudoBot(msg) or ManagerAll(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or ManagerAll(msg) or AdminAll(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or ManagerAll(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or ManagerAll(msg) or AdminAll(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if Status or SudoBot(msg) or ManagerAll(msg) or AdminAll(msg) or VipAll(msg) or RioConstructor(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Admin(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
--     Source David     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then DavidTeam  = "المطور" elseif RioSudo(msg) then DavidTeam = "المطور" elseif SecondSudo(msg) then DavidTeam = "المطور" elseif SudoBot(msg) then DavidTeam = "المطور" elseif ManagerAll(msg) then DavidTeam = "المدير" elseif AdminAll(msg) then DavidTeam = "الادمن" elseif RioConstructor(msg) then DavidTeam = "المالك" elseif BasicConstructor(msg) then DavidTeam = "المنشئ" elseif Constructor(msg) then DavidTeam = "المنشئ" elseif Manager(msg) then DavidTeam = "المدير" elseif Admin(msg) then DavidTeam = "الادمن" else DavidTeam = "العضو" end return DavidTeam end
...
local key = {
{'↫ المطورين ↯','↫ الثانويين ↯','↫ الاساسيين ↯'},
{'مسح المطورين','مسح الثانويين','مسح الاساسيين'},
{'↫ تغير المطور الاساسي ↯'},
{'↫ تغيير كليشه المطور ↯'},
{'↫ رجوع ↯'},
}
...
if text == 'جلب رد الخاص' or text == '↫ جلب رد الخاص ↯' then  
local start = DevRio:get(David.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
--     Source David     --
if text == "السورس" or text == "سورس" or text == "↫  السورس ↯" then 
Text = [[
Welcome To Source
...
if DevRio:get(David.."Rio:ChId") then DevCh = '\n↯︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙تم تنزيله من ↫ ⤈\n~ ( "..riosudo..secondsudo..sudobot..managerall..adminall..vpall..basicconstructor..constructor..manager..admins..vipmem..cleaner.." ) ~")  
else 
...
function raf_reply(extra, result, success)
if not SudoBot(msg) and DevRio:get(David.."Rio:Lock:ProSet"..msg.chat_id_) then 
...
--     Source David     --
if text == "المطورين الاساسيين" and RioSudo(msg) or text == "الاساسيين" and RioSudo(msg) or text == "↫ الاساسيين ↯" then 
...
--     Source David     --
if text == "المطورين الثانويين" and SecondSudo(msg) or text == "الثانويين" and SecondSudo(msg) or text == "↫ الثانويين ↯" and SecoundSudo(msg) then 
...
if Number > 1000 then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙لاتستطيع تنظيف اكثر من 1000 رساله', 1, 'md')
return false  
end  
...
--     Source David     --
if text and (text == "تفعيل امسح" or text == "تفعيل المسح التلقائي" or text == "تفعيل الحذف التلقائي") and SudoBot(msg) and ChCheck(msg) then
local DavidTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امسح مع ميزة الحذف التلقائي للميديا'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DavidTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(David..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text and (text == "تعطيل امسح" or text == "تعطيل المسح التلقائي" or text == "تعطيل الحذف التلقائي") and SudoBot(msg) and ChCheck(msg) then
...
--     Source David     --
if text == 'حذف رد من متعدد' and SudoBot(msg) and ChCheck(msg) or text == 'مسح رد من متعدد' and SudoBot(msg) and ChCheck(msg) then
...
if text == 'حذف رد متعدد' and SudoBot(msg) and ChCheck(msg) or text == 'مسح رد متعدد' and SudoBot(msg) and ChCheck(msg) then
local List = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
...
if text == 'اضف رد متعدد' and SudoBot(msg) and ChCheck(msg) then
...
--     Source David     --
if text == 'حذف رد' and SudoBot(msg) and ChCheck(msg) or text == 'مسح رد' and  SudoBot(msg) and ChCheck(msg) then
...
if text == 'اضف رد' and SudoBot(msg) and ChCheck(msg) then
...
if text == 'حذف الردود المتعدده' and SudoBot(msg) and ChCheck(msg) or text == 'مسح الردود المتعدده' and SudoBot(msg) and ChCheck(msg) then
local redod = DevRio:smembers(David..'Rio:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
else
...
--     Source David     --
if text == 'الردود' and SudoBot(msg) and ChCheck(msg) or text == 'ردود المدير' and SudoBot(msg) and ChCheck(msg) then
...
if text == 'حذف الردود' and SudoBot(msg) and ChCheck(msg) or text == 'مسح الردود' and SudoBot(msg) and ChCheck(msg) or text == 'حذف ردود المدير' and SudoBot(msg) and ChCheck(msg) or text == 'مسح ردود المدير' and SudoBot(msg) and ChCheck(msg) then
local redod = DevRio:smembers(David..'Rio:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
...
if text == "حذف ردود المطور" and SecondSudo(msg) or text == "حذف ردود العام" and SecondSudo(msg) or text == "مسح ردود المطور" and SecondSudo(msg) or text == "↫ مسح ردود العام ↯" then
local redod = DevRio:smembers(David.."Rio:Sudo:AllRed")
if #redod == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
else
...
--     Source David     --
if text == 'نقل الاحصائيات' or text == '↫ نقل الاحصائيات ↯' then
...
if text == "متجر الملفات" or text == 'المتجر' or text == '↫  المتجر ↯' then
...
--     Source David     --
if text and text:match("^ضع كليشه المطور$") or text and text:match("^وضع كليشه المطور$") or text and text:match("^تغيير كليشه المطور$") or text and text:match("^↫ تغيير كليشه المطور ↯$") then
if not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙للمطور الاساسي فقط ', 1, 'md')
else
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/tsttt&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
if RioSudo(msg) then 
